...
//
#ifndef __vtkSMXML_FTLECUDACPUv2wofor_h
#define __vtkSMXML_FTLECUDACPUv2wofor_h

#include <string.h>


// From file /export/home/urawat/Desktop/TD/src/FTLE_Server.xml
static const char* const FTLECUDACPUv2woforFTLE_ServerInterfaces0 =
...
"                                  default_values=\"100\">\n"
"                <Documentation>Set advection time for the flow map computation</Documentation>\n"
...
"\n";
// Get single string
char* FTLECUDACPUv2woforFTLE_ServerInterfaces()
{
  size_t len = ( 0
    + strlen(FTLECUDACPUv2woforFTLE_ServerInterfaces0) );
  char* res = new char[ len + 1];
  res[0] = 0;
  strcat(res, FTLECUDACPUv2woforFTLE_ServerInterfaces0);
  return res;
}
