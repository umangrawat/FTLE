...
//
#ifndef __vtkSMXML_FTLECUDA_h
#define __vtkSMXML_FTLECUDA_h

#include <string.h>


// From file /export/home/urawat/Desktop/TD/src/FTLE_Server.xml
static const char* const FTLECUDAFTLE_ServerInterfaces0 =
...
"\n";
// Get single string
char* FTLECUDAFTLE_ServerInterfaces()
{
  size_t len = ( 0
    + strlen(FTLECUDAFTLE_ServerInterfaces0) );
  char* res = new char[ len + 1];
  res[0] = 0;
  strcat(res, FTLECUDAFTLE_ServerInterfaces0);
  return res;
}
