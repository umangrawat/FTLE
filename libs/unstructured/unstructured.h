...
#  endif
 ...
 public:
  ...
  void computeCriticalPoints(double time=0.0, int type=0, bool only2D=false, int mode=0, double param=1.0, int iparam=1);
...
#elif 0
  double integrate(vec3 xyz, bool forward, double maxTime, double maxDist, int maxSteps, int order=4, bool keepOffWall=false, double startTime=0.0, double *distDone=NULL, bool tensorLine=false, vec3 direction=NULL, bool interpolateTensor=false, int evIdx=0, double timeWeight=1.0, double maxStep=0.0);
#else
  double integrate(vec3 xyz, bool forward, double maxTime, double maxDist, int maxSteps, int order=4, bool keepOffWall=false, double startTime=0.0, double *distDone=NULL, bool tensorLine=false, vec3 direction=NULL, bool interpolateTensor=false, int evIdx=0, double timeWeight=1.0, double maxStep=0.0, bool Lorentz=false, vec3 iniVelo=NULL, double mass=0.0, double charge=0.0);
#endif
