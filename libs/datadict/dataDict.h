...
class DataDict
{
    public:
        ...
        int byteSize() { return nBytes; }
        bool setByteSize(int n);

        float minTime() { return min; }
        float maxTime() { return max; }
        ...
        float* data0() { return ts0->data; }
        float* data1() { return ts1->data ? ts1->data : ts0->data; }
        float weight0() { return wt0; }
        float weight1() { return wt1; }
        float dweight0() { return dwt0; }
        float dweight1() { return dwt1; }
